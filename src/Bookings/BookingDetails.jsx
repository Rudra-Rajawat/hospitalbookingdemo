...
//   const fetchBookings = () => {
//     // Change URL based on role if needed
//     let url = 'http://localhost:9096/bookings/getAll';
//     if (auth.role === 'PATIENT') {
//       const patientId = localStorage.getItem('patientId');
//       url = `http://localhost:9096/bookings/getByPatientId/${patientId}`;
...
//     axios
//       .put(`http://localhost:9096/bookings/updateBooking/${currentBooking.id}`, editForm, {
//         headers: {
//           Authorization: `Bearer ${auth.token}`
//         }
//       })
...
//     // If the user is a patient, fetch only their bookings
//     if (auth.role === 'PATIENT') {
//       // Assumes auth.id holds the patient's ID
//       url = `http://localhost:9096/bookings/getByPatientId/${auth.id}`;
//     }
